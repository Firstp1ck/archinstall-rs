...
mod tests {
    ...
    fn test_partition_cmds_bios_swap_luks() {
        ...
        assert_eq!(cmds[11], "mkfs.btrfs -f /dev/mapper/cryptroot");
    }
    ...
    fn test_setup_commands_lvm_on_luks() {
        ...
        assert_eq!(cmds[4], "lvcreate -L 50GiB vg_system -n lv_root");
        assert_eq!(cmds[5], "mkfs.ext4 -F /dev/vg_system/lv_root");
